...
echo ""
echo "Test CDC:"
echo "   - Create order: curl -X POST http://localhost:8080/api/test/cdc/create -H 'Content-Type: application/json' -d '{\"orderId\":\"test-123\",\"customerId\":\"customer-123\",\"quantity\":1,\"price\":100}'"